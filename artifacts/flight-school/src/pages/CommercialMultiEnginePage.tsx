  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="Add a Multi-Engine rating to your Commercial Pilot certificate at Van Nuys Airport (KVNY), Los Angeles. $3,000–$4,000 — below the SoCal average of $5,000–$8,000. No written exam required. Call 310-490-0402." />
