...
const vSpeeds = [
  { label: "Vr", value: "60 kts", name: "Rotation Speed", desc: "The speed at which you lift the nosewheel off the runway to begin the takeoff climb. At Vr you apply back pressure and the aircraft becomes airborne." },
  { label: "Vx", value: "63 kts", name: "Best Angle of Climb", desc: "Gives you the most altitude for the least horizontal distance. Used when you need to clear an obstacle shortly after takeoff — a tree line, power lines, or a rising terrain feature directly ahead." },
  { label: "Vy", value: "79 kts", name: "Best Rate of Climb", desc: "Gives you the most altitude per unit of time. This is the normal climb speed used on departure when there are no obstacle concerns — it gets you to cruise altitude fastest." },
  { label: "Vs1", value: "50 kts", name: "Stall Speed — Flaps Up", desc: "The lowest speed at which the wing can sustain level flight in a clean (flaps-up) configuration. Below this speed with flaps up, the wing will stall. Critical for understanding stall entry during training maneuvers." },
  { label: "Vso", value: "44 kts", name: "Stall Speed — Full Flaps", desc: "Stall speed in landing configuration (flaps fully extended). This is the absolute minimum flying speed during the approach to land. Your approach should always remain well above this speed." },
  { label: "Vg", value: "73 kts", name: "Best Glide Speed", desc: "The speed that gives you the maximum glide distance if the engine fails. Immediately pitch to Vg during an engine failure — it extends the time and distance available to locate a landing spot. This is one of the most important emergency speeds you will memorize." },
  { label: "Va", value: "88–111 kts", name: "Maneuvering Speed", desc: "The maximum speed at which you can apply full, abrupt control deflection without risking structural damage. In turbulence or rough air, slow to or below Va to protect the airframe. The range accounts for varying aircraft gross weights — lower weight = lower Va." },
  { label: "Vno", value: "126 kts", name: "Maximum Structural Cruise Speed", desc: "The top of the green arc on the airspeed indicator. You may fly up to this speed in smooth air. Above Vno, the aircraft enters the yellow 'caution' arc — fly here only in smooth air and avoid abrupt control inputs." },
  { label: "Vfe", value: "103 kts", name: "Maximum Flap Extended Speed", desc: "The fastest you may fly with flaps extended. Exceeding Vfe with flaps down risks structural damage to the flap system. When extending flaps on approach, confirm airspeed is at or below Vfe first." },
  { label: "Vfinal", value: "65 kts", name: "Final Approach Speed", desc: "The target airspeed flown on final approach to landing. Provides an appropriate margin above stall while delivering a stable, controllable descent profile to the runway threshold." },
  { label: "Vne", value: "160 kts", name: "Never-Exceed Speed", desc: "The red line on the airspeed indicator — the absolute structural limit of the airframe. Exceeding Vne risks permanent structural damage or inflight breakup. Never intentionally fly beyond this speed under any circumstances." },
  { label: "Max Crosswind", value: "17 kts", name: "Maximum Demonstrated Crosswind", desc: "The maximum crosswind component demonstrated safe during flight testing. Operations in crosswinds above this value require particular caution. Student pilots typically practice crosswind landings well below this limit to build skill progressively." },
];
    ...
    <div className="divide-y divide-slate-100">
      {vSpeeds.map((v, i) => (
        <div key={v.label} className="overflow-hidden">
          ...
          >
            <span className="w-16 shrink-0 font-mono font-bold text-primary text-sm">{v.label}</span>
            <span className="w-24 shrink-0 font-bold text-secondary text-sm">{v.value}</span>
            <span className="flex-1 text-slate-700 font-medium text-sm">{v.name}</span>
            {openIdx === i
  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="Train in a 1985 Piper PA28 Cherokee Warrior II N9172Y. IFR equipped, Garmin GNS 430, ADS-B. V-speeds, performance specs, and POH reference. $160/hr wet. Call 818-469-1414." />
      </Helmet>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-12">
            ...
            <div className="p-8 md:p-12">
              <div className="md:flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-3xl font-bold text-primary mb-2">1985 Piper PA28 Cherokee Warrior II — N9172Y</h2>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  { title: "ADS-B Out", desc: "Broadcasts aircraft position to ATC and other aircraft." },
                  { title: "ADS-B In via ForeFlight", desc: "Traffic and weather awareness on an iPad." },
                  { title: "Stable Training Platform", desc: "Beginner-friendly handling characteristics." },
                  { title: "Comfort & Quality", desc: "Leather seats and rigorous maintenance standards." },
                ].map((f) => (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-primary text-white rounded-2xl shadow-sm p-8">
              ...
              <div className="space-y-4 text-primary-foreground/85 leading-relaxed">
                ...
                <p>
                  In other flight schools, students especially young ones or students who are not aware of how flight schools work, and the goals of most instructors, will spend time and money, with a terrible instructor, and fail multiple stage checks, or even checkrides, yet be told it was their fault, as these instructors only care about keeping their own job, while not caring at all about your piloting aspirations.
                </p>
