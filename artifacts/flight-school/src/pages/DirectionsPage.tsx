        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="flex items-start gap-3 bg-amber-100 border border-amber-300 rounded-xl p-5">
            ...
            <div>
              ...
              <a href="tel:818-469-1414" className="mt-3 inline-flex items-center gap-2 text-sm font-bold text-amber-900 underline underline-offset-2">
                <Phone className="w-4 h-4" /> 818-469-1414
              </a>
            </div>
          </div>
        </div>
          ...
          <ol className="space-y-5">
            {[
              ...
              },
              {
                ...
                detail: "Before you enter, call or text 818-469-1414. We will give you the access code for the red gate immediately."
              },
              {
                step: "3",
