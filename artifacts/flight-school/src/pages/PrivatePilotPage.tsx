  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="Earn your Private Pilot License at Van Nuys Airport (KVNY), Los Angeles. FAA ACS-structured training. Estimated $7,500–$12,500 — half the SoCal average. No upfront payment. Call 310-490-0402." />
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-primary rounded-xl p-6 text-white sticky top-24">
                ...
                <div className="space-y-3">
                  <a href="tel:310-490-0402" className="block w-full">
