...
const faqs: Faq[] = [
  {
    ...
    a: (
      <>
        At a steady pace of <strong>2 to 3 flights per week</strong> (each
        averaging about 2 hours), most students go from their first lesson to
        the checkride in about <strong>2 to 3 months</strong>. Your exact
        timeline depends on how consistently you fly, how much you study at
        home, and how quickly you reach proficiency.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Flying <strong>2 to 3 times per week</strong>, the Instrument Rating
        typically takes about <strong>2 to 3 months</strong>. As with all of our
        training, consistency and home study are the biggest factors in
  ...
  },
  {
    ...
    a: (
      <>
        Commercial training can take anywhere from{" "}
        <strong>1 to 4 months</strong>, depending largely on how many flight
        hours you already have toward the FAA aeronautical experience
        requirements. If you still need to build hours, that will extend the
        timeline; if you already meet the experience requirements, it can move
        quickly.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        To <strong>begin</strong> training, you really just need the desire to
        learn and the ability to show up consistently. You do{" "}
        <strong>not</strong> need any certificate, medical, or prior experience
        to start taking lessons. The main requirements come later, before your
        first solo. To eventually earn a certificate you must be able to read,
        speak, write, and understand English, and be at least 17 years old by
        your Private Pilot checkride (you can start much younger).
      </>
    ),
  },
  {
    ...
    a: (
      <>
        When you fly <strong>solo</strong> you must have on you: a{" "}
        <strong>government-issued photo ID</strong>, your{" "}
        <strong>student pilot certificate</strong>, and your{" "}
        <strong>medical certificate</strong>. Your <strong>logbook</strong> with
        the proper instructor endorsements must also be available. While
        training with an instructor on board, the instructor carries the legal
        responsibility, but it is good practice to always have your ID and
  ...
  },
  {
    ...
    a: (
      <>
        Before your first solo you must have: a{" "}
        <strong>student pilot certificate</strong>, an{" "}
        <strong>FAA medical certificate</strong> (at least third class), and the
        specific <strong>instructor endorsements</strong> in your logbook for
        solo flight. You also must have demonstrated to your instructor that you
        can safely perform the required maneuvers and handle the aircraft on
        your own — including normal and crosswind takeoffs and landings, and
  ...
  },
  {
    ...
    a: (
      <>
        You can solo once you are at least <strong>16 years old</strong>, hold a
        student pilot certificate and a medical certificate, and your instructor
        has endorsed you after confirming you can safely operate the aircraft on
        your own. There is no fixed number of hours — it happens when you are{" "}
        <strong>ready and proficient</strong>.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Many students reach their first solo within a <strong>few weeks</strong>{" "}
        when flying 2 to 3 times per week and studying at home. There is no
        required minimum number of hours to solo — it happens when you have
        shown your instructor you can safely handle the aircraft. Consistency is
        the single biggest factor in getting there faster.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <strong>Yes.</strong> If you show proficiency, we will set you up for
        the checkride as soon as you demonstrate you are capable of passing —
        which means you will need <strong>less training</strong> with us. We do
        not artificially pad hours. We meet you where you are, fill any gaps,
        and move you toward your checkride as efficiently as your skills allow.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <strong>Yes.</strong> If you show proficiency and can pass a mock
        checkride — or fully demonstrate the skills for whatever specific
        endorsement you are seeking (solo, solo cross-country, or checkride) —
        you will get the endorsement. We will not sign you off until you are
        genuinely ready, because the endorsement means we are confident you can
        perform safely and pass.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <strong>Yes.</strong> Not only will you get the flight training you
        need, but our focus will also be on{" "}
        <strong>how a career in aviation actually works</strong> — including{" "}
        <strong>Single-Pilot Resource Management (SRM)</strong>,{" "}
        <strong>Crew Resource Management (CRM)</strong>, and{" "}
        <strong>professionalism</strong>. We prepare you not just to pass
        checkrides, but to operate the way airlines and employers expect a
        professional pilot to operate.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        You do not need a medical certificate for your very first lessons, but
        you <strong>do need an FAA medical certificate before you solo</strong>.
        We recommend getting your medical early in training (a third-class
        medical is the minimum for Private Pilot) so that nothing slows down
        your progress when you are ready to fly on your own. We can point you to
        a local Aviation Medical Examiner.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        ...
        sit in the pilot seat and <strong>actually fly the aircraft</strong>{" "}
  ...
  },
  {
    ...
    a: (
      <>
        <strong>Yes.</strong> Flight training is not just showing up and flying.
        Students who study the FAA materials at home make faster progress, spend
        less money, and pass their written, oral, and flight tests more
        confidently. We are upfront about this from day one and tell you exactly
        what to study, when, and why — so no lesson is wasted reviewing material
      ...
      <section className="bg-primary text-white py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto">
            Everything you want to know about timelines, soloing, transferring
            from another school, and getting started. Still have a question?
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mt-12 bg-primary/5 border border-primary/15 rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-600 mb-6">
              We are happy to answer anything, even if you are completely new to
