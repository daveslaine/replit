      ...
      <section className="py-14 md:py-18 bg-white">
        <div className="container mx-auto px-4 max-w-3xl space-y-5">
          <p className="text-slate-700 leading-relaxed text-base md:text-lg">
            Most "air tours" over Los Angeles put you in the back of a
          ...
          <p className="text-slate-700 leading-relaxed text-base md:text-lg">
            Pick the route or landmark that excites you most. Each guide below
            covers what you might see, how the flight works, and what to expect.
            Exact routing always depends on weather, air traffic control, and
            safety on the day — but every flight departs from Van Nuys Airport
            and includes the aircraft and your instructor.
          </p>
      ...
      <section className="py-14 bg-slate-50">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-slate-500 mb-8 max-w-2xl">
            Every flight is a hands-on discovery lesson from Van Nuys Airport.
            Tap a route to see the details.
          </p>
