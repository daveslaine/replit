      ...
      <section className="relative bg-primary text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cheapest Flight School in Van Nuys CA — Without Cheap Training
          </h1>
          <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto mb-8">
            Affordable does not mean unstructured. Our low prices come from
            efficiency, honest rates, and proactive scheduling — not from
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-2 text-sm">
              All aircraft rentals are <strong>wet</strong> — fuel is always
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-2 text-sm max-w-2xl mx-auto">
              These are realistic total cost estimates including all flight
              hours, instructor time, and aircraft rental. DPE checkride fees
              are separate ($700–$1,200 per test, paid directly to the
              examiner).
            </p>
          </div>
              ...
              >
                <div className="grid md:grid-cols-3 gap-0">
                  <div className="p-5 md:border-r border-slate-200">
                    ...
                    {p.minHours && (
                      <p className="text-xs text-slate-500">
                        FAA minimum: {p.minHours} hrs · Typical:{" "}
                        {p.typicalHours} hrs
                      </p>
                    )}
                    {!p.minHours && (
                      <p className="text-xs text-slate-500">
                        Typical: {p.typicalHours}
                      </p>
                    )}
                  ...
                  <div className="p-5 bg-red-50 flex flex-col justify-center">
                    ...
                    <p className="text-2xl font-bold text-red-800 line-through decoration-red-400">
                      {p.socal}
                    </p>
          ...
          <p className="text-center text-slate-400 text-xs mt-4">
            Estimates vary based on individual proficiency, weather, and
            scheduling frequency. Call us for a personalized breakdown.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-3 max-w-2xl mx-auto">
              Most people assume that a higher price means higher quality in
              flight training. The opposite is often true. Large academies
              charge more because they carry high overhead — not because their
              instructors are better. We charge less because we're efficient,
              honest, and we genuinely care about your outcome.
            </p>
          </div>
      ...
      <section className="py-14 bg-primary text-white">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <p className="text-primary-foreground/85 leading-relaxed mb-5">
            At many flight schools, the rate is high because the school has
            large overhead — admin staff, fleet maintenance departments,
            marketing budgets, fancy lobbies. None of that makes you a better
            pilot. In fact, at larger schools, the instructor assigned to you is
            often the least experienced one available, compensated just enough
            to keep them from leaving.
          </p>
          <p className="text-primary-foreground/85 leading-relaxed mb-5">
            We charge a fair price and provide high quality because we want
            students to pass, return, and refer others. Our reputation is built
            entirely on results — not advertising. When you succeed, we succeed.
          </p>
          <p className="font-bold text-white text-lg">
            The cheapest flight training is the training you finish fastest —
            with the fewest wasted hours.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 bg-white text-center">
        <div className="container mx-auto px-4 max-w-2xl">
          <h2 className="text-2xl font-bold text-primary mb-3">
            Ready to start for less?
          </h2>
          <p className="text-slate-500 mb-7">
            Call or text us — we'll give you a realistic cost estimate for your
            specific goals, schedule, and starting point.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="tel:424-493-2761">
              <Button
