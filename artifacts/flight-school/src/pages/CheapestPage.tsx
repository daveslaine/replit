  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="The cheapest flight school in Van Nuys CA — with real pricing. Private Pilot ~$7,500–$12,500. Zero to Commercial + CFI ~$40,000–$55,000. Aircraft $160/hr wet. Structured, ACS-based. Call 310-490-0402." />
