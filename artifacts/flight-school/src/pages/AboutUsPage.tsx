      ...
      <section className="relative bg-primary text-white pt-28 md:pt-32 pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            About Accelerated Flight School
          </h1>
          <p className="text-xl text-primary-foreground/90 leading-relaxed max-w-3xl mx-auto">
            Professional flight instructors with decades of real-world
            experience — teaching at one of the nation's busiest general
            aviation airports.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary mb-6">
                Experienced Pilots. Dedicated Instructors.
              </h2>
              <div className="space-y-4 text-slate-700 leading-relaxed">
                <p>
                  Accelerated Flight School is operated by professional flight
                  instructors who have been active pilots since the early 2000s
                  — bringing more than two decades of flight experience to every
                  lesson. Our instructors have accumulated thousands of flight
                  hours across a wide range of aircraft, conditions, and
                  airspace types.
                </p>
                <p>
                  We are not a factory school with rotating instructors assigned
                  by availability. When you train with us, you train
                  consistently with instructors who have a direct stake in your
                  success and who have personally navigated every rating, every
                  checkride, and every real-world flying challenge you will
                  face.
                </p>
                <p>
                  Accelerated Flight School is affiliated with{" "}
                  <strong>Accelerated Flight Academy</strong>.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  title: "Flying Since the Early 2000s",
                  detail:
                    "Over two decades of active pilot experience across diverse aircraft, conditions, and airspace.",
                },
                {
                  icon: <Users className="w-5 h-5 text-secondary shrink-0" />,
                  title: "Small School, Real Attention",
                  detail:
                    "You work with the same instructors from your first lesson through your checkride — no handoffs, no strangers.",
                },
                {
                  icon: (
                    <GraduationCap className="w-5 h-5 text-secondary shrink-0" />
                  ),
                  title: "FAA Part 61 Certified",
                  detail:
                    "All training follows FAA Part 61 regulations with full Airman Certification Standards (ACS) integration.",
                },
                {
                  icon: <Shield className="w-5 h-5 text-secondary shrink-0" />,
                  title: "Student Success is Our Responsibility",
                  detail:
                    "We don't pass students who aren't ready, and we don't fail students who deserved better instruction.",
                },
              ].map((item) => (
                <div
                  key={item.title}
            ...
            {[
              {
                ...
                detail:
                  "Van Nuys Airport handles more general aviation operations than almost any other airport in the US. Training here means real ATC communication, real traffic awareness, and real workload — not practice in an empty pattern at a quiet rural airport.",
              },
              {
                title: "Direct Access to Class B Airspace",
                detail:
                  "KVNY sits just outside the LAX Class B veil. Our students regularly fly through and around Los Angeles Class B airspace, developing confidence and skill that pilots training at quieter airports simply don't acquire.",
              },
              {
                title: "Diverse Training Terrain",
                detail:
                  "From KVNY you can reach beaches, mountains, high desert, and multiple towered airports within 30 minutes. Cross-country training here is genuinely diverse — ocean, mountain passes, desert strips, and major metro airports all within reach.",
              },
              {
                title: "Year-Round Flying Weather",
                detail:
                  "Southern California's climate means minimal weather cancellations for VFR training, while proximity to the Pacific marine layer provides natural opportunities for IFR training without needing to travel to poor-weather regions.",
              },
              {
                title: "Multiple Nearby Class D and Class C Airports",
                detail:
                  "Burbank BUR (Class C), Camarillo CMA, Whiteman WHP, Santa Monica SMO, Long Beach LGB — all within easy navigation range. You will regularly visit controlled airports that most students never see until their checkride.",
              },
              {
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  ...
                  Certification Standards (<AviationTerm term="ACS" />
                  ). The ACS is the FAA's official testing guide and grading
                  standard for pilot checkrides. A Designated Pilot Examiner (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-primary mt-1">
                  Scenario-Based, Confidence-Building Instruction
                </h3>
              </div>
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  We use scenario-based training so students learn efficiently
                  and build confidence faster. Most training at other schools
                  limits students to a narrow set of routes between
                  school-approved waypoints. This is inadequate for real-world
                  piloting.
                </p>
                <p>
                  Piloting is all about smooth, confident flying even in new
                  situations and under pressure. When flying with our
                  instructors, you will learn instinctively how to:
                </p>
                <ul className="space-y-2 pl-2">
                  {[
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              ...
              <p className="text-slate-600 leading-relaxed">
                We help you pass the FAA written exams the first time — and with
                a high score. Any question you miss on the written becomes a
                topic you must explain perfectly during the oral portion of your{" "}
                <AviationTerm term="Checkride" />. A high written score makes
                your oral exam significantly easier. We point you to exactly the
                right study resources so you know what to focus on, and what
                high scores actually look like.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-primary mt-1">
                  Honest Study Expectations
                </h3>
              </div>
              <p className="text-slate-600 leading-relaxed">
                Flight training requires studying outside of your lessons. We
                are transparent about this from day one. Pilots who study the
                FAA materials before arriving at the airport make faster
                progress, spend less money, and pass checkrides more
                confidently. We tell you exactly what to study, when, and why —
                so no lesson is wasted reviewing ground concepts you could have
                covered at home.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary mb-6">
                Well-Maintained Training Aircraft at Van Nuys Airport
              </h2>
              <div className="space-y-4 text-slate-700 leading-relaxed">
                <p>
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  {[
                    { label: "Wet Rental Rate", value: "From $155/hr" },
                    { label: "Fleet Range", value: "$155-$175/hr" },
              ...
              <Link href="/van-nuys-accelerated-flight-school-aircraft">
                <div className="bg-white rounded-2xl border border-slate-200 p-6 hover:border-secondary transition-colors cursor-pointer">
                  ...
                  <p className="text-sm text-slate-600">
                    Full specs, avionics details, and rental requirements for
        ...
        <div className="container mx-auto px-4 max-w-4xl">
            ...
            {[
              {
                ...
                detail:
                  "You pay per flight hour only. No deposits, no training packages forced upfront, no large advance payments. Start training with a single discovery flight if you want.",
              },
              {
                icon: <CheckCircle2 className="w-6 h-6 text-secondary" />,
                title: "No Loan Financing",
                detail:
                  "We do not partner with pilot loan programs. Flight school loans often cost $250,000–$300,000 by payoff. We believe you deserve to train at honest prices without predatory debt.",
              },
              {
                icon: <CalendarClock className="w-6 h-6 text-secondary" />,
                title: "Checkride Scheduling Advantage",
                detail:
                  "We proactively schedule your DPE checkride while you train — so you test within 1–3 weeks of completion, not 2–5 months after. This saves real money.",
              },
            ].map((item) => (
              <div
                key={item.title}
          ...
          <div className="bg-primary/5 border border-primary/15 rounded-xl p-6">
            <h3 className="font-bold text-primary mb-3">
              What Our Pricing Looks Like vs. The SoCal Average
            </h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              {[
                ...
                {
                  program: "Commercial Pilot (from zero)",
                  ours: "~$40,000–$55,000",
                ...
                <div
                  key={row.program}
                  className="flex justify-between items-center bg-white rounded-lg border border-slate-200 px-4 py-3"
                >
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-8">
              ...
              <div className="space-y-3 text-slate-700">
                ...
                <p className="text-sm text-slate-500">
                  We schedule flights 7 days a week to fit working students' and
                  professionals' schedules. Early morning, evening, and weekend
                  slots are available.
                </p>
              </div>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200 p-8">
              ...
              <div className="space-y-2 text-slate-700">
                ...
                <p className="text-sm text-slate-500 pt-2">
                  Accessible from the 405, 101, and 118 freeways. Serving the
                  greater Los Angeles area including the San Fernando Valley,
                  Conejo Valley, Simi Valley, Santa Clarita, Glendale, Burbank,
                  and the Westside.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-white text-center">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <p className="text-slate-500 mb-8">
            Call or text us. We'll explain exactly where to begin — no pressure,
            no commitments.
          </p>
