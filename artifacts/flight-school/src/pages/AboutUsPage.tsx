  ...
  return (
    <div className="w-full">
      <Helmet>
        ...
        <meta name="description" content="Accelerated Flight School at Van Nuys Airport (KVNY). Experienced flight instructors flying since the early 2000s. Structured FAA ACS training. Affordable, transparent pricing. No upfront payment. Call 310-490-0402." />
