        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="font-bold text-lg text-white mb-1">
              Completely new to aviation?
            </p>
            <p className="text-primary-foreground/70 text-sm">
              Call or text us and we'll explain where to start. No pressure, no
              commitments.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-primary-foreground/70 text-sm">
                Structured. Transparent. Affordable.
              </p>
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  },
                  {
                    ...
                    label: "LA Air Tours & Sightseeing",
                  },
                  {
                    href: "/van-nuys-accelerated-flight-school-pricing",
                    label: "Van Nuys Flight School Pricing",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    label: "Cheapest Flight School Van Nuys",
                  },
                  {
                    href: "/low-cost-flight-school-van-nuys-ca",
                    label: "Low-Cost Flight Training Van Nuys",
                  },
                ].map((link) => (
                  <li key={link.href}>
                    <Link
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <a
                  href="mailto:fly@acceleratedflightschool.net"
                  className="flex items-center gap-2 text-primary-foreground/70 hover:text-white transition-colors text-sm break-all"
                >
