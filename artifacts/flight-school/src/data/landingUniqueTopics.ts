...
export const landingUniqueTopics: Record<string, UniqueSection> = {
  "affordable-flight-training-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        "Beyond the standard $175/hr wet aircraft rate, Accelerated Flight School offers a 10-hour block at $165/hr wet. That $10/hr difference looks small until you scale it across a full certificate. A student who flies 60 hours saves $600 simply by buying time in blocks rather than one lesson at a time.",
  ...
  "cheap-flight-school-los-angeles-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      ...
      "At Accelerated Flight School the rates are already low for the Los Angeles market, but the bigger savings come from a focused, ACS-based syllabus that keeps every hour productive. Book a Discovery Flight for $230 to see the structure firsthand, or call 323-332-0585.",
    ],
  },
  ...
  "discovery-flight-van-nuys-accelerated-flight-school-kvny": {
    ...
    paragraphs: [
      ...
      "The 1.5-hour flight is genuine instruction, so it is logged toward the hours you will eventually need for a certificate. Pricing is $230 for one person or $270 for two if you would like to share the experience, weight and balance permitting. We are at 7910 Balboa Blvd H7, Van Nuys, CA 91406; call or text 323-332-0585 to book.",
    ],
  },
  "private-pilot-training-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        ...
        "The final phase is checkride preparation: polishing maneuvers to ACS tolerances, rehearsing the oral exam, and flying mock checkrides so the real one feels familiar. The FAA minimum is 40 hours and most students finish in 60–75, so at the $215/hr dual rate (or about $205/hr using the 10-hour block) you can estimate your investment with confidence. Call 323-332-0585 to map your timeline.",
      ],
    },
  "instrument-rating-los-angeles-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      ...
      "Flying instruments in the Los Angeles basin means real handoffs between Burbank and SoCal approach and real traffic to integrate with — exactly the environment instrument-rated pilots use after the checkride. Every lesson ends with a debrief tied to the instrument ACS so you always know which task is next. The dual rate is $215/hr; call or text 323-332-0585 to begin.",
    ],
  },
  "commercial-pilot-training-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        ...
        "Because the certificate also requires reaching 250 total hours, much of the path is solo time building, and the $165/hr wet 10-hour block makes those cross-country hours noticeably more affordable than one-off rentals. N9172Y is well suited to both the maneuver training and the time building. Call or text 323-332-0585 to outline your commercial plan.",
      ],
    },
  ...
  "flight-instructor-van-nuys-accelerated-flight-school-kvny": {
    ...
    paragraphs: [
      ...
      "Every flight is bracketed by a clear briefing and an honest debrief, so you always know the objective before you start the engine and exactly how you did afterward. Instruction is $40/hr, and combined with N9172Y at $175/hr wet the dual rate is $215/hr. Call or text 323-332-0585 to set up your first lesson.",
    ],
  },
  ...
  "cfii-near-me-los-angeles-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      ...
      "A strong CFII also ties every lesson to the instrument ACS so you can see your progress task by task, and gives you an honest read on how many hours you still need. Instruction in N9172Y runs at the $215/hr combined dual rate. Call or text 323-332-0585 to talk through your current hours and goals.",
    ],
  },
  ...
  "piper-warrior-flight-training-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        ...
        "For the LA-area pilot, the Warrior comfortably handles cross-country legs toward Camarillo, Santa Barbara, the Central Valley, and the high desert, which makes it practical for both training and later time building. The wet rate is $175/hr, dropping to $165/hr on a 10-hour block, with instruction at $40/hr. Call or text 323-332-0585 to schedule a lesson.",
      ],
    },
  "pay-as-you-fly-flight-training-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        "Pay-as-you-fly is easiest to understand at the level of one lesson. A typical 1.5-hour dual flight bills the aircraft at $175/hr wet and the instructor at $40/hr, so you pay roughly $293 for that session and nothing more. There is no deposit drawn down, no package balance to track, and no surprise line items.",
  ...
  "flight-school-cost-los-angeles-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      ...
      "The dual time runs 50 hours at $215/hr, or about $9,750. The solo time adds 15 hours of aircraft at $175/hr wet, roughly $2,400, bringing flight costs to around $12,150. On top of flight time, plan for the FAA knowledge test (about $175), a checkride examiner fee (commonly $400–$700 in the LA area), study materials (anywhere from free resources up to about $400), and a medical certificate ($75–$200).",
      "All in, that representative private pilot certificate lands in the neighborhood of $13,000–$13,800. Shifting the aircraft time onto the $165/hr wet 10-hour block would shave several hundred dollars off the flight portion. For an estimate built around your own pace and background, call or text 323-332-0585.",
    ],
  },
  ...
  "instrument-rating-cost-los-angeles-accelerated-flight-school-van-nuys-kvny":
    {
      ...
      paragraphs: [
        "Most of the instrument rating bill is dual instruction, since the rating is taught almost entirely with a CFII beside you. That makes the aircraft rate the lever worth pulling. Using the 10-hour aircraft block at $165/hr wet instead of $175/hr brings your effective dual rate to about $205/hr.",
        ...
        "A representative instrument budget at Accelerated Flight School: around 45 dual hours at the blocked $205/hr, roughly $9,225 in flight time, plus the knowledge test (about $175) and the examiner fee (commonly $700–$900 for the instrument checkride). Call or text 323-332-0585 for an estimate based on your current hours.",
      ],
    },
  "time-building-los-angeles-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      "When you are accumulating hours toward the 250 required for a commercial certificate, the aircraft rate is the number that compounds fastest. This is exactly where the 10-hour block at $165/hr wet pays off: every block you fly saves $100 against the standard $175/hr rate, and those savings stack across dozens of hours.",
  ...
  "flight-review-van-nuys-accelerated-flight-school-kvny": {
    ...
    paragraphs: [
      ...
      "If it has genuinely been a while, plan for a little more than the minimum so the review can do its real job of rebuilding proficiency. Aircraft time is $175/hr wet and instruction is $40/hr, so a typical review is modest in cost. Call or text 323-332-0585 to schedule.",
    ],
  },
  "instrument-proficiency-check-van-nuys-accelerated-flight-school-kvny": {
    ...
    paragraphs: [
      ...
      "Van Nuys is a strong place to do it, with ILS, VOR, and RNAV approaches and live ATC to brief and fly against. The check is conducted by a CFII in N9172Y at $175/hr wet plus $40/hr instruction, and most IPCs run two to four hours total. Call or text 323-332-0585 to schedule yours.",
    ],
  },
  ...
  "learn-to-fly-los-angeles-accelerated-flight-school-van-nuys-airport-kvny": {
    ...
    paragraphs: [
      ...
      "There is a real learning curve, and plateaus are normal; the structured, ACS-based syllabus is what carries you through them with a clear objective each time you fly. Lessons are $215/hr dual in N9172Y, and the lowest-risk way to begin is a $230 Discovery Flight. Call or text 323-332-0585 to get started.",
    ],
  },
  "how-to-get-instrument-rating-in-los-angeles-accelerated-flight-school-van-nuys-airport-kvny":
    {
      ...
      paragraphs: [
        ...
        "Training out of Van Nuys, you build those skills against real clearances and the ILS, VOR, and RNAV approaches in the area. Plan roughly 40–60 hours of instrument instruction in N9172Y at $215/hr dual, less if you use the 10-hour aircraft block. Call or text 323-332-0585 to map your route to the rating.",
      ],
    },
