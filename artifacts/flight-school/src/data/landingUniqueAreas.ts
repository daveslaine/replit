...
export const landingUniqueAreas: Record<string, UniqueSection> = {
  ...
  "flight-school-near-simi-valley-accelerated-flight-school-van-nuys-kvny": {
    ...
    paragraphs: [
      ...
      "All flying is done in our Piper PA-28 Cherokee Warrior II (N9172Y), and the controlled, active environment at KVNY is great for night work as you build toward the certificate. There is no prepaid package; a Discovery Flight is $230 for one person if you want to start simple. Call or text 323-332-0585.",
    ],
  },
